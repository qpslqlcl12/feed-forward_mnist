...
def network_initializer():   
    ini_w1=tf.Variable(tf.random.uniform([11029,5500],-1,1), trainable=True)      
    ini_w2=tf.Variable(tf.random.uniform([5500,2700],-1,1), trainable=True)
    ini_w3=tf.Variable(tf.random.uniform([2700,1300],-1,1), trainable=True)
    ini_w4=tf.Variable(tf.random.uniform([1300,600],-1,1), trainable=True)
    ini_w5=tf.Variable(tf.random.uniform([600,300],-1,1), trainable=True)
